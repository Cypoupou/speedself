...
class UserController extends Zend_Controller_Action {
    ...
    public function edituserAction() {
        ...
        $user = new Application_Model_DbTable_User();
        // Update the user
        $verif = $user->updateUser($idUser, $firstname, $lastname, $email, $tel);
        // Update the Session variables @todo
    ...
    public function informationsAction($msg = null) {
        ...
        $editForm->hydrateForm(array(
            'idUserEdit' => $auth->getIdentity()->UserId,
    ...
    public function rechargerAction() {
        $auth = Zend_Auth::getInstance();
        $idUser = $auth->getIdentity()->UserId;

        $userTab = new Application_Model_DbTable_User();
        $user = $userTab->fetchOne($idUser);
